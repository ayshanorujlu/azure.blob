...
namespace AzureStorageLibrary.Services
{
    public class BlobStorage : IBlobStorage
    {
        ...
        public string? BlobUrl { get; set; } = "https://task2ayshan.blob.core.windows.net";
        ...
        public Task UploadAsync(Stream fileStream, string fileName, EContainerName eContainerName, string v)
        {
