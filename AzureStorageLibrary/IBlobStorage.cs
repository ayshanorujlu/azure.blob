...
namespace AzureStorageLibrary
{
    ...
    public interface IBlobStorage
    {
        ...
        Task UploadAsync(Stream fileStream, string fileName, EContainerName eContainerName, string v);
        ...
        Task UploadAsync(Stream stream, string newFileName, EContainerName pictures);
    }
}
